...
def NOTIFIED_KICKOUT_FROM_GROUP(op):
	...
	sendMessage(op.param1, client.getContact(op.param3).displayName + " Kamu di kick Dada 􀜁􀅔Har Har􏿿")
    except Exception as e:
        print e
...
#-----------------------------------------------------------------------------------------------------------------------------------
		...
		if msg.text == "up":
		    sendMessage(msg.to,"hay")
		    sendMessage(msg.to,"gua Alferd")
		    sendMessage(msg.to,"eh")
                    sendMessage(msg.to,"cogan cina")
		    sendMessage(msg.to,"hobi main game")
		    sendMessage(msg.to,"cita cita jadi dosen")
    		    sendMessage(msg.to,"buat bales dendam entar")
		    sendMessage(msg.to,"line gua")
		    sendMessage(msg.to,"2000")
     		    sendMessage(msg.to,"bulan")
		    sendMessage(msg.to,"september")
		    sendMessage(msg.to,"tanggal")
		    sendMessage(msg.to,"11")
		    sendMessage(msg.to,"hari")
		    sendMessage(msg.to,"senin")
    		    sendMessage(msg.to,"zodiak")
		    sendMessage(msg.to,"Virgo")
		if msg.text == "buka":
                    group = client.getGroup(msg.to)
                ...
                if "invallclone" in msg.text:
                    print "\n[invite all clone]ok\n"
                    mid1 = ("u5bd97b202c575c35ab41584ec37a8c96")
                    mid2 = ("ua7fb5762d5066629323d113e1266e8ca")
                    mid3 = ("uf4a837a5f4e413ac811d790f8f578bc9")
                    mid4 = ("u12c5cf853784842cd2e4354e91e66804")
                    mid5 = ("ud9edf0839dfce7707aad2cc75aec75e9")
                    mid6 = ("u396a912c8db1496c74b51ec3e832b0d5")
                    mid7 = ("u936ded389916aa9eaa897325299fd848")
                    mid8 = ("u798bee62f98bb77a87463ecb1de87f46")
		    try:
			...
			client.findAndAddContactsByMid(mid2)
                ...
                if "kickallclone" in msg.text:
                    ...
                    print "\n[kick all clone]ok\n"
                    mid1 = ("u5bd97b202c575c35ab41584ec37a8c96")
                    mid2 = ("uad72c84b6f11e53d6da34d50ebb69402")
                    mid3 = ("ua7fb5762d5066629323d113e1266e8ca")
                    mid4 = ("uf4a837a5f4e413ac811d790f8f578bc9")
                    mid5 = ("u12c5cf853784842cd2e4354e91e66804")
                    mid6 = ("ud9edf0839dfce7707aad2cc75aec75e9")
                    mid7 = ("u396a912c8db1496c74b51ec3e832b0d5")
                    mid8 = ("u798bee62f98bb77a87463ecb1de87f46")
                    try:
		...
		if "kickallmybf" in msg.text:
		    ...
		    mid2 = ("u12c5cf853784842cd2e4354e91e66804")
		    mid3 = ("ud9edf0839dfce7707aad2cc75aec75e9")
		    try:
                        client.kickoutFromGroup(msg.to,[mid1])
                        client.kickoutFromGroup(msg.to,[mid2])
                        client.kickoutFromGroup(msg.to,[mid3])
		...
		if "cancelallmybf" in msg.text:
		    ...
		    mid1 = ("u396a912c8db1496c74b51ec3e832b0d5")
		    mid2 = ("u936ded389916aa9eaa897325299fd848")
		    mid3 = ("u798bee62f98bb77a87463ecb1de87f46")
		    try:
                        client.cancelGroupInvitation(msg.to,[mid1])
                        client.cancelGroupInvitation(msg.to,[mid2])
                        client.cancelGroupInvitation(msg.to,[mid3])
		...
		if "listclone" in msg.text:
		    mid1 = ("uf4a837a5f4e413ac811d790f8f578bc9")
                    mid2 = ("uf4a837a5f4e413ac811d790f8f578bc9")
                    mid3 = ("uf4a837a5f4e413ac811d790f8f578bc9")
                    mid4 = ("uf4a837a5f4e413ac811d790f8f578bc9")
                    mid5 = ("uf4a837a5f4e413ac811d790f8f578bc9")
                    mid6 = ("uf4a837a5f4e413ac811d790f8f578bc9")
                    mid7 = ("uf4a837a5f4e413ac811d790f8f578bc9")
                    mid8 = ("uf4a837a5f4e413ac811d790f8f578bc9")
